const planetData = {
    ...
    earth: {
        ...
        texturePath: "Images/Earth Day Clouds.jpg"
    },
    mars: {
        name: "Mars",
    ...
    moon: {
        name: "Moon",
        overview: "The Moon is Earth's only natural satellite. It is the fifth-largest satellite in the Solar System and the largest and most massive relative to its parent planet, with a diameter about one-quarter that of Earth. The Moon is a planetary-mass object with a differentiated rocky body, making it a satellite planet under the geophysical definitions of the term. It lacks any significant atmosphere, hydrosphere, or magnetic field.",
        physical: {
            diameter: "3,474 km (0.27 times Earth's diameter)",
            mass: "7.342 × 10^22 kg (0.012 times Earth's mass)",
            composition: "Rock with iron-rich core",
            temperature: "Day: 127°C, Night: -173°C",
            gravity: "1.62 m/s² (0.17 times Earth's gravity)"
        },
        orbit: {
            distance: "384,400 km from Earth",
            period: "27.3 Earth days",
            speed: "1.022 km/s",
            rotation: "27.3 Earth days (synchronous rotation)",
            tilt: "5.145 degrees to the ecliptic"
        },
        atmosphere: {
            composition: "Extremely thin, with traces of helium, argon, sodium, potassium",
